...
class _AnimationPageState extends State<AnimationPage>
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: new AppBar(
        title: new Text('动画效果', style: new TextStyle(color: Colors.white)),
...
class _StaggeredAniWidgetState extends State<StaggeredAniWidget>
  ...
  Animation<double> opacity; //透明度
  Animation<EdgeInsets> movement; //移动
  Animation<Color> color; //颜色
  Animation<BorderRadius> radius; //角度
  Animation<double> rotate; //旋转
  Animation<double> width; //宽
  Animation<double> height; //高
